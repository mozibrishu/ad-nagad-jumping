...
setInterval(() => {
  ...
  if (man + 31 >= obstacle && obstacle + 22 && manTop >= 115) {
    t1.pause();
    setTimeout(() => {
      t1.play();
    }, 2000);
...
t1 = gsap.timeline({ delay: 2.5 })
  ...
  .to('.pp_slide_2 .pp_element_3', { opacity: 1, y: 0, x: -100, duration: 2.6, ease: Linear.easeNone }, '>.1')
  .to('.pp_slide_2 .pp_element_3', { opacity: 0, y: -20, duration: .5, ease: Linear.easeNone }, '>')
  .to('.pp_slide_2 .pp_element_3', { opacity: 0, y: 0, x: 180, duration: .1, ease: Linear.easeNone }, '>.1')
  .to('.pp_slide_2 .pp_element_3', { opacity: 1, y: 0, x: 180, duration: .1, ease: Linear.easeNone }, '>.1')
  .to('.pp_slide_2 .pp_element_3', { opacity: 1, y: 0, x: -100, duration: 2.8, ease: Linear.easeNone }, '>.1')
  .to('.pp_slide_2 .pp_element_3', { opacity: 0, y: -20, duration: .5, ease: Linear.easeNone }, '>')
  // obstacle animation
  .fromTo('.pp_slide_2 .pp_element_5', { left: 130 }, { left: 30, duration: 1, ease: Linear.easeNone }, 1.5)
  .fromTo('.pp_slide_2 .pp_element_5', { left: 350 }, { left: 30, duration: 3.5, ease: Linear.easeNone }, 4)
